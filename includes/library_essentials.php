...
// se $valore non � passato elimina il campo dalla query_string
//
...
// se $valori[$campo] non � passato elimina il campo dalla query_string
//
...
//echo "</pre>";
	//
	// se una chiave univoca esisteva gi� lascio 
